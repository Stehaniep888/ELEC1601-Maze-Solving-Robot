...
//    for (i = 0; i < 5; i++)
//    {
//        xDir = round(robotCentreX+(-ROBOT_WIDTH/2)*sin((robot->angle+90)*PI/180)-(-ROBOT_HEIGHT/2-SENSOR_VISION+sensor_sensitivity*i)*cos((robot->angle+90)*PI/180));
//        yDir = round(robotCentreY+(-ROBOT_WIDTH/2)*cos((robot->angle+90)*PI/180)+(-ROBOT_HEIGHT/2-SENSOR_VISION+sensor_sensitivity*i)*sin((robot->angle+90)*PI/180));
//        xTL = (int) xDir;
//        yTL = (int) yDir;
//
//        SDL_Rect rect = {xTL, yTL, 2, sensor_sensitivity};
...
void robotAutoMotorMove(struct Robot * robot, int right_sensor, int front_sensor, int left_sensor) {

    int real_angle = robot->angle % 90;
    printf("front: %d\n", front_sensor);
    printf("right: %d\n", right_sensor);
    printf("left: %d\n", left_sensor);
    printf("speed: %d\n", robot ->currentSpeed);
    ...
    if((front_sensor == 0) && (right_sensor == 0)&& (a == 1)){
     ...
     else if((front_sensor == 0) && (right_sensor == 0)&& (a == 0)){
            robot ->direction = RIGHT;
            if (robot ->currentSpeed < 3){
                robot ->direction = UP;
                printf("speed1: %d\n", robot ->currentSpeed);
    ...
    else if(left_sensor >= 3 && right_sensor >= 3 && front_sensor ==0){
            a = 0;
        robot ->direction = DOWN;
        robot ->direction = LEFT;
    }
//    else if(right_sensor == 0 && left_sensor == 4 && front_sensor >=3){
//        robot ->direction = DOWN;
//    }
//    else if(right_sensor == 1 && left_sensor == 3 && front_sensor >=3){
//        robot ->direction = DOWN;
//    }
//    else if(right_sensor == 2 && left_sensor == 2 && front_sensor >=3){
//        robot ->direction = DOWN;
//    }
//    else if(right_sensor == 3 && left_sensor == 1 && front_sensor >=3){
//        robot ->direction = DOWN;
//    }
    else if(left_sensor == 0 && right_sensor ==2 && front_sensor ==0){
            a = 0;
        robot ->direction = LEFT;
    }
    else if(left_sensor >= 1 && right_sensor >= 1 && front_sensor >=3){
        a = 0;
        printf("HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
        robot ->direction = LEFT;
    ...
    else if(left_sensor >= 3 && right_sensor >= 1 && front_sensor >=1){
            a = 0;
            if (robot ->currentSpeed > 1){
                robot ->direction = DOWN;
            }
    ...
    else if((front_sensor == 0) && (right_sensor == 1)){
        a = 0;
        robot ->direction = RIGHT;
    }
    else if((front_sensor == 0) && (right_sensor == 2)){
        a = 0;
            //robot ->direction = RIGHT;
    ...
    else if (front_sensor > 2 && right_sensor < 2){
        a = 0;
            if (robot ->currentSpeed > 2){
                robot ->direction = DOWN;
            }
    ...
    else if (front_sensor == 0 && right_sensor >= 3){
            a = 0;
            if (robot ->currentSpeed < 3){
                robot ->direction = UP;
            }
    }
    else if (front_sensor >= 3 && right_sensor >= 2){
        a = 0;
            if (robot ->currentSpeed >3){
                robot ->direction = DOWN;
            }
...
//            }
    ...
    else if (front_sensor > 0 && left_sensor >= 1){
            a = 0;
            if (robot ->currentSpeed >3){
                robot ->direction = DOWN;
            }
